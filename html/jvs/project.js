	...
	var Pagination = function () {
		function Pagination(_ref2) {
			var pages = _ref2.pages,
			    ...
			    arrows = _ref2$arrows === undefined ? true : _ref2$arrows;
			...
			if (this.pages > 9999) this.dom.slider.addClass("tenthousand");
			/* If bigger than 1000 */
			else if (this.pages > 999) this.dom.slider.addClass("thousand");
				/* If bigger 100 */
				else if (this.pages > 99) this.dom.slider.addClass("hundred");
